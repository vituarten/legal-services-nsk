        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              {/* Кнопки - ИСПРАВЛЕННАЯ ВЕРСИЯ */}
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white shadow-xl shadow-blue-600/30 text-lg px-8 py-6 rounded-xl font-semibold"
                ...
                <Button
                  size="lg"
                  className="bg-transparent border-2 border-white/50 text-white hover:bg-white hover:text-slate-900 hover:border-white text-lg px-8 py-6 rounded-xl font-semibold transition-all duration-300"
                  onClick={handlePhoneClick}
                >
                  <Icon name="Phone" size={24} className="mr-3" />
                  <span className="text-white group-hover:text-slate-900">
                    {CONTACTS.phone}
                  </span>
                </Button>
              </div>
