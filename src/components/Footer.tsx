      ...
      <div className="container mx-auto px-4 sm:px-6 py-10 sm:py-12 md:py-16">
        ...
        <div className="space-y-6 sm:space-y-8">
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="text-xs text-muted-foreground space-y-1 leading-relaxed">
                ...
                <p className="text-xs opacity-75 mt-2">
                  ИНН/ОГРНИП проверены в ФНС РФ. Юридическая деятельность
                  лицензирована.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4 text-xs">
            <div className="flex flex-wrap justify-center sm:justify-start gap-x-4 sm:gap-x-6 gap-y-1 text-muted-foreground">
              <a
                href="/privacy"
            ...
            <div className="flex items-center gap-2 mt-2 sm:mt-0">
              ...
              <div className="flex gap-1.5">
                ...
                <div className="text-xs px-1.5 py-0.5 bg-blue-50 text-blue-700 rounded border border-blue-200">
                  МВД
                </div>
              </div>
            </div>
