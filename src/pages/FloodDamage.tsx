...
export default function FloodDamagePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    fetch("/api/lead", {
      ...
      alert(
        `Спасибо, ${userData.name}! Мы свяжемся с вами в течение 15 минут.`,
      );
    });
  };
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-8 pt-4">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm mb-6">
                  <span className="animate-pulse">●</span> Онлайн • Консультация
                  0 ₽ • Договор онлайн
                </div>
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  За 20 минут вы узнаете: какие документы готовить, как общаться
                  с виновником и сколько можно взыскать.
                </p>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-10 items-start">
                ...
                <div className="space-y-8">
                  ...
                  {/* Блок связи - ИСПРАВЛЕННЫЙ ВАРИАНТ */}
                  <div className="bg-white rounded-2xl border-2 border-gray-200 p-6">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      ...
                      <a
                        href={TG_LINK}
                        target="_blank"
                        className="p-4 bg-[#0088cc] text-white rounded-xl flex flex-col items-center justify-center hover:bg-[#0077b5] transition-colors"
                      >
                        <svg
                      ...
                      <a
                        ...
                        className="p-4 bg-gradient-to-r from-gray-700 to-gray-800 text-white rounded-xl flex flex-col items-center justify-center hover:from-gray-800 hover:to-gray-900 transition-all"
                      >
                        <svg
                          className="w-6 h-6 mb-2"
                          fill="none"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl mb-10 text-white/80 max-w-2xl mx-auto">
                Это ваш шанс получить профессиональную оценку ситуации, прежде
                чем совершить ошибку, которая обойдётся в десятки тысяч рублей.
              </p>
