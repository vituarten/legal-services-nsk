...
export default function BankruptcyLawyer() {
  ...
  const advantages = [
    ...
    { icon: 'Clock', title: '1-3 месяца', text: 'Средний срок завершения процедуры банкротства' },
  ];
  ...
  const cases = [
    ...
    { debt: '1.8 млн ₽', result: 'Списано 100%', time: '6 месяцев', situation: 'Долги по ЖКХ + кредиты' },
  ];

  return (
    <>
      <Helmet>
        <title>Банкротство физических лиц в Новосибирске | Списание долгов от 20 000₽</title>
        <meta name="description" content="Возмещение ущерба от потопов под ключ. Списываем долги по кредитам, МФО, ЖКХ законно. Сохраняем единственное жильё. Процедура онлайн за 1-3 месяца." />
      </Helmet>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-5xl font-bold mb-6 leading-tight">
                  Возмещение ущерба от потопов — законное списание всех долгов
                </h1>
                <p className="text-xl text-muted-foreground mb-8">
                  Избавим от долгов по кредитам, МФО, ЖКХ навсегда. Сохраним единственное жильё. Процедура онлайн за 1-3 месяца. Стоимость от 20 000₽
                </p>
