...
export default function BankruptcyLawyer() {
  ...
  const advantages = [
    ...
    { icon: 'Clock', title: '2-6 месяцев', text: 'Средний срок завершения процедуры банкротства' },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Банкротство физических лиц в Новосибирске | Списание долгов от 15 000₽</title>
        <meta name="description" content="Взыскание долгов под ключ. Списываем долги по кредитам, МФО, ЖКХ законно. Сохраняем единственное жильё. Процедура онлайн за 2-6 месяцев." />
      </Helmet>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-5xl font-bold mb-6 leading-tight">
                  Взыскание долгов — законное списание всех долгов
                </h1>
                <p className="text-xl text-muted-foreground mb-8">
                  Избавим от долгов по кредитам, МФО, ЖКХ навсегда. Сохраним единственное жильё. Процедура онлайн за 2-6 месяцев. Стоимость от 15 000₽
                </p>
