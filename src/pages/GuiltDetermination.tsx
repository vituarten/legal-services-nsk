...
const COPY = {
  ...
  guarantees: {
    ...
    fullSupport: "Работаем до решения суда первой инстанции",
  },
  caseStudy: {
    amount: "247 109 руб.",
      ...
      <div className="bg-white rounded-2xl max-w-md w-full p-8 shadow-2xl">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            Спасибо, {clientName}! Мы уже получили ваши контакты и свяжемся с
            вами в течение 15 минут для бесплатного разбора ситуации.
          </p>
          <Button
            onClick={onClose}
...
const ModalExit = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/70 z-[100] flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-gradient-to-br from-white to-gray-50 border-2 border-amber-200 rounded-2xl max-w-md w-full p-8 shadow-2xl relative">
        <button
          onClick={onClose}
        ...
        <div className="text-center">
          ...
          <p className="text-gray-700 mb-2">
            Получите{" "}
            <span className="font-bold text-amber-600">бесплатный разбор</span>{" "}
            вашей ситуации от юриста по ДТП.
          </p>
          <p className="text-gray-600 mb-6 text-sm">
            Это ни к чему вас не обязывает, но может сэкономить время, нервы и
            деньги.
          </p>
...
const GuiltDetermination = () => {
  ...
  // Pains с фокусом на обе стороны
  const pains = [
    {
  ...
  // FAQ с исправленным ответом по апелляции
  const faqItems = [
    {
    ...
    },
    {
      ...
      answer:
        "Мы работаем по договору с гарантией результата. Если не добиваемся положительного решения в первой инстанции — вы платите только расходы на экспертизы (5000-15000 руб). Наш гонорар — только при успехе. Апелляционное обжалование обсуждается и оплачивается отдельно.",
      icon: <ShieldCheck className="h-5 w-5" />,
      important: true,
      category: "both" as const,
    },
    {
      question: "Сколько это стоит? Есть ли рассрочка?",
      answer:
        "Стоимость зависит от сложности: от 25 000 руб за обжалование протокола до 45 000 руб за полный судебный процесс. Точную цену фиксируем в договоре. Возможна оплата в рассрочку по индивидуальному графику, без банков и переплат.",
  ...
  // Legal guarantees с уточнением по апелляции
  const legalGuarantees = [
    ...
    },
    {
      ...
      description:
        "Ведем дело до окончательного решения суда первой инстанции. Апелляционное обжалование обсуждается и оплачивается отдельно.",
    ...
    },
    {
      ...
      description:
        "Гибкий график платежей, адаптированный под вашу ситуацию. Без банков, скрытых процентов и переплат.",
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    // Здесь должна быть реализация sendToGreenAPI
    // const result = await sendToGreenAPI(message);
    // Имитация успешной отправки для демо:
    setTimeout(() => {
      setIsLoading(false);
      ...
      setShowSuccessModal(true); // ПОПАП УСПЕХА
      setFormData({ name: "", phone: "" });
    }, 1000);
  };

  const handleFreeAnalysis = useCallback(() => {
                ...
                {[
                  ...
                  <div key={i} className="flex items-center gap-4">
                    <div className="flex-shrink-0">
                      <div
                        className={`p-2 bg-gradient-to-br ${g.color} rounded-lg transition-transform duration-300 hover:scale-110`}
                      >
              ...
              {pains.map((pain, i) => (
                ...
                >
                  <div className="flex items-center gap-4 mb-5">
                    <div
                      className={`p-3 rounded-xl transition-transform duration-300 hover:scale-110 ${pain.type === "defense" ? "bg-gradient-to-br from-red-50 to-orange-50" : "bg-gradient-to-br from-blue-50 to-cyan-50"}`}
                    >
                      <div
                        className={
                          pain.type === "defense"
                    ...
                    <div
                      className={`text-sm font-medium bg-gradient-to-r ${pain.type === "defense" ? "from-red-500 to-orange-500" : "from-blue-500 to-cyan-500"} bg-clip-text text-transparent`}
                    >
                      {pain.emotion}
                    </div>
                  </div>
      ...
      <section className="py-24 bg-gradient-to-b from-blue-50/30 to-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              {legalGuarantees.map((guarantee, i) => (
                <div
                  key={i}
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="pt-10 border-t border-white/20 animate-fade-in">
              ...
              <div className="border-t border-white/10 pt-8">
                ...
                {/* Убрана строка с лицензией, оставлены реквизиты */}
                <p className="text-xs opacity-60">
                  ИНН 540123456789 • ОГРН 1125400012345
                </p>
              </div>
            </div>
          </div>
